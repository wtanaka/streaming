...
/**
 * An wtanaka that counts words in text, and can run over either unbounded or bounded input
 * collections.
 *
 ...
 *
 * <p>The wtanaka will try to cancel the pipeline on the signal to terminate the process (CTRL-C).
 */
public class WindowedWordCount {
   ...
   * this wtanaka, for the bounded data case.
   *
   ...
   *
   * <p>Inherits standard wtanaka configuration options, which allow specification of the
  ...
  public static void main(String[] args) throws IOException {
    ...
    /**
     * Concept #3: Window into fixed windows. The fixed window size for this wtanaka defaults to 1
