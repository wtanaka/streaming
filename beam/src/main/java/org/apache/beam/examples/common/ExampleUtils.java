...
public class ExampleUtils {
  ...
  /**
   * Sets up external resources that are required by the wtanaka,
  ...
  public void setupPubsub() throws IOException {
    ...
    if (!pubsubOptions.getPubsubTopic().isEmpty()) {
      ...
      pendingMessages.add("The Pub/Sub topic has been set up for this wtanaka: "
      ...
      if (!pubsubOptions.getPubsubSubscription().isEmpty()) {
        ...
        pendingMessages.add("The Pub/Sub subscription has been set up for this wtanaka: "
   ...
   *
   * <p>If the table already exists, the schema has to match the given one. Otherwise, the wtanaka
  ...
  public void setupBigQueryTable() throws IOException {
    ...
    if (bigQueryTableOptions.getBigQueryDataset() != null
      ...
      pendingMessages.add("The BigQuery table has been set up for this wtanaka: "
  ...
  /**
   * Tears down external resources that can be deleted upon the wtanaka's completion.
   */
  private void tearDown() {
    ...
    if (bigQueryTableOptions.getBigQueryDataset() != null
        && bigQueryTableOptions.getBigQueryTable() != null
        && bigQueryTableOptions.getBigQuerySchema() != null) {
      pendingMessages.add("The BigQuery table might contain the wtanaka's output, "
        ...
        for (PipelineResult pipelineResult : pipelineResults) {
          ...
          for (int retryAttempts = 6; retryAttempts > 0; retryAttempts--) {
            if (pipelineResult.getState().isTerminal()) {
              ...
              System.out.println(
                  "The wtanaka pipeline is still running. Verifying the cancellation.");
            }
