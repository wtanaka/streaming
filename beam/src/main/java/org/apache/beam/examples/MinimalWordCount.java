...
public class MinimalWordCount {
  ...
  public static void main(String[] args) {
    ...
    // options for our pipeline, such as the runner you wish to use. This wtanaka
    ...
    // This wtanaka reads a public data set consisting of the complete works of Shakespeare.
